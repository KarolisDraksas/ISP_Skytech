        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('prekespridejimas') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="kodas" type="text" class="form-control @error('kodas') is-invalid @enderror" name="kodas" value="{{ old('kodas') }}" required autocomplete="kodas" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="gamintojas" type="text" class="form-control @error('gamintojas') is-invalid @enderror" name="gamintojas" value="{{ old('gamintojas') }}" required autocomplete="gamintojas" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="aprašymas" type="text" class="form-control @error('aprašymas') is-invalid @enderror" name="aprašymas" value="{{ old('aprašymas') }}" required autocomplete="aprašymas" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="kaina" type="number" class="form-control @error('kaina') is-invalid @enderror" name="kaina" value="{{ old('kaina') }}" required autocomplete="kaina" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="kiekis" type="number" class="form-control @error('kiekis') is-invalid @enderror" name="kiekis" value="{{ old('kiekis') }}" required autocomplete="kiekis" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="kat3" class="col-md-4 col-form-label text-md-right">{{ __('Kategorija') }}</label>

                                <div class="col-md-6" id="kat3">
