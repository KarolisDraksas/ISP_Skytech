                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profilisredagavimas') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telephone" type="tel"   value="{{$user['telephone']}}" pattern="[8]{1}[6]{1}[0-9]{7}" placeholder="860000000" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ old('telephone') }}" required autocomplete="telephone" autofocus>
